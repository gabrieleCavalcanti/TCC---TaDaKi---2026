...
export class PostController {
    ...
    constructor(
        private _service = new PostService()
    ) {}
    ...
    criar = async (
        ...
        try {
            ...
            if (!req.file) {
                ...
                return res.status(400).json({
                    message:
                        "A imagem do post é obrigatória"
                });
            }

            const vincularImagem =
                req.file.filename;
    ...
    editar = async (
        ...
        try {
            ...
            /*
                Se mandar uma imagem nova:
                usa req.file.filename.
    ...
    selecionaById = async (
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    message:
                        "O ID do post deve ser um número válido"
                });
            }
